...
public class LiveFragmentActivity extends Fragment {
	...
	private DatabaseReference live = _firebase.getReference("live");
	private ChildEventListener _live_child_listener;
	...
	private void initialize(Bundle _savedInstanceState, View _view) {
		...
		_live_child_listener = new ChildEventListener() {
			@Override
		...
		live.addChildEventListener(_live_child_listener);
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			if (_data.get((int)_position).containsKey("duration")) {
				testdate.setText(_data.get((int)_position).get("duration").toString());
			}
			_borderline(Cet_Physics_test, "#D1C4E9", 1.5d, "#9e9e9e", 25);
			button16.setOnClickListener(new View.OnClickListener() {
				@Override
				public void onClick(View _view) {
					i.setClass(getContext().getApplicationContext(), WebsiteActivity.class);
					i.putExtra("link", _data.get((int)_position).get("link").toString());
					startActivity(i);
				}
			});
